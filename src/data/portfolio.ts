...
const websiteVideo = '/portfolio/website.mov';
const hanNguyenEducationVideo = '/portfolio/han-nguyen-education.mov';
const reactChronometerVideo = '/portfolio/react-chronometer.mov';
const johnTranCodeVideo = '/portfolio/johntran-code.mov';
const angeleFerrereVideo = '/portfolio/angele-ferrere.mov';
const fortuneWheelVideo = '/portfolio/fortune-wheel.mov';
...
const pigtokenVideo = '/portfolio/pigtoken.mov';
