    ...
    <main className="flex-grow pt-20">
        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-xl text-stone-600 max-w-3xl mx-auto leading-relaxed">
              Découvre les endroits incroyables que j'ai eu la chance de visiter. 
              Chaque destination m'a appris quelque chose de nouveau sur le monde et sur moi-même.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            <div className="p-8 bg-stone-50 border-b">
              <h2 className="text-3xl font-serif font-bold text-center mb-4">Carte Interactive</h2>
              <p className="text-stone-600 text-center">
                Clique sur les marqueurs pour découvrir mes aventures !
              </p>
            </div>
      ...
      <section className="py-16 px-6 bg-stone-50">
        <div className="max-w-7xl mx-auto">
          ...
          >
            <h2 className="text-4xl font-serif font-bold mb-4">Mes Destinations</h2>
            <p className="text-xl text-stone-600">
              Un aperçu de mes aventures autour du monde
            </p>
          </motion.div>
              ...
              const card = (
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <p className="text-stone-700 leading-relaxed">{destination.description}</p>
                    {destination.slug && (
          ...
          >
            <div className="relative z-10">
              <h2 className="text-3xl md:text-4xl font-serif font-bold mb-4">
                Envie de voyager ensemble ? ✈️
              </h2>
              <p className="text-xl text-stone-300 mb-8 max-w-2xl mx-auto">
                Si tu as des recommandations de destinations ou si tu veux partager tes propres aventures, 
